"""
models/clip_b16.py
OpenAI CLIP ViT-B/16 wrapper for SafeUpload.
"""
...
class CLIPb16Model(nn.Module):
    ...
    def __init__(self, device="cuda"):
        ...
        # Store CLIP's own preprocess (PIL-based) for no-grad evaluation
        self._clip_preprocess = preprocess

        # Tensor-compatible normalisation for gradient passes
    ...
    def _tensor_preprocess(self, x):
        """Differentiable preprocessing: resize + normalise."""
